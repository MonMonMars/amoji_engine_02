...
export const YUE_VOICE_PROFILES = Object.freeze([
  ...
  },
  {
    ...
    edgeVoice: "zh-HK-HiuMaanNeural",
    shortLabel: "曉曼·雅",
    shortLabelEn: "HiuMaan·Aesthe",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiumaan.mp3",
    prosodyBias: { rate: 2, pitch: 8, volume: 2 },
  },
  {
    id: "zh-HK-HiuGaaiNeural-shiro",
    edgeVoice: "zh-HK-HiuGaaiNeural",
    shortLabel: "曉佳·白",
    shortLabelEn: "HiuGaai·Shiro",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiugaai.mp3",
  ...
  {
    id: "zh-HK-HiuGaaiNeural-hina",
    edgeVoice: "zh-HK-HiuGaaiNeural",
    shortLabel: "曉佳·陽菜",
    shortLabelEn: "HiuGaai·Hina",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiugaai.mp3",
  ...
  {
    id: "zh-HK-HiuMaanNeural-mio",
    edgeVoice: "zh-HK-HiuMaanNeural",
    shortLabel: "曉曼·澪",
    shortLabelEn: "HiuMaan·Mio",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiumaan.mp3",
  ...
  {
    id: "zh-HK-HiuMaanNeural-ruri",
    edgeVoice: "zh-HK-HiuMaanNeural",
    shortLabel: "曉曼·璃",
    shortLabelEn: "HiuMaan·Ruri",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiumaan.mp3",
  ...
  {
    id: "zh-HK-HiuGaaiNeural-poly",
    edgeVoice: "zh-HK-HiuGaaiNeural",
    shortLabel: "曉佳·波莉",
    shortLabelEn: "HiuGaai·Poly",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiugaai.mp3",
  ...
  {
    id: "zh-HK-HiuMaanNeural-jennifer",
    edgeVoice: "zh-HK-HiuMaanNeural",
    shortLabel: "曉曼·珍妮",
    shortLabelEn: "HiuMaan·Jennifer",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiumaan.mp3",
    prosodyBias: { rate: 8, pitch: 14, volume: 4 },
  },
  {
    id: "zh-HK-HiuGaaiNeural-circle",
    edgeVoice: "zh-HK-HiuGaaiNeural",
    shortLabel: "曉佳·圓圓",
    shortLabelEn: "HiuGaai·Circle",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiugaai.mp3",
  ...
  {
    id: "zh-HK-HiuGaaiNeural-pyre",
    edgeVoice: "zh-HK-HiuGaaiNeural",
    shortLabel: "曉佳·焰靈",
    shortLabelEn: "HiuGaai·Pyre",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiugaai.mp3",
  ...
  {
    id: "zh-HK-HiuMaanNeural-samplec",
    edgeVoice: "zh-HK-HiuMaanNeural",
    shortLabel: "曉曼·塞琳",
    shortLabelEn: "HiuMaan·Celine",
    lang: "zh-HK",
    gender: "female",
    source: "Edge TTS",
    samplePath: "/prototypes/assets/voice-samples/hiumaan.mp3",
    prosodyBias: { rate: 5, pitch: 8, volume: 3 },
  },
]);

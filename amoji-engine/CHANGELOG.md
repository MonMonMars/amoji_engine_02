...
- Companion HD: Michelle GLTF girl + Unreal-style OrbitControls (drag orbit / scroll zoom), closer portrait framing; falls back to procedural/2D when WebGL missing
